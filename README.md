**If you only want to get  a static view of our interactive tool**, just download and open the htm file (**Static_view_of_my_interactive_webpage.html**) in your browser (we recommend chrome)**. To get an **interactive webpage** you need to follow the installation steps and the section **Usage of the Web-based application**
