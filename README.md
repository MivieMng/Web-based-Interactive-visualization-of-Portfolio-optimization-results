...
- To get an **interactive webpage** you can do it in two different ways : using our Software (**"MIPOpti"**), this is the easiest way, or using our python scripts. We create **MIPOpti** to ease the use of this project, indeed using our software you don't nee to install anything, all you have to do is to download and run it.
